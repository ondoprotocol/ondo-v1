...
describe("SushiStakingV2Strategy - ETH-YGG-JR-LOSE-ALL helper", async function () {
  ...
  before(async function () {
    ...
    this.vaultParams = {
      hurdleRate: 20000, //10000+(percentage*100) i.e., this represents 100% or 1200%APY
      startTime,
    ...
    this.harvestWaitDays = 8; //wait for these many days before next harvest
