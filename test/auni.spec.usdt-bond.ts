...
import { shouldBehaveLikeVault } from "./behaviour/auniswap/vaultLifecycle";
import { shouldValidateUniStrategyDeployment } from "./behaviour/auniswap/uniStrategySetup";
import { shouldBehaveLikeVaultDuringUniv2Investments } from "./behaviour/auniswap/invest";
use(solidity);
...
describe("BondStrategy - USDC-BOND helper", async function () {
  ...
  before(async function () {
    ...
    this.seniorInvestmentPerInvestor = 60000;
    ...
    this.numberOfTokensToBeBoughtWithEth = 60000; //number of USDT tokens to be bought
